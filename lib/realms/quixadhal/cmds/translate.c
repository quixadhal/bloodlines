...
#define GOOGLE_TRANSLATE "74.125.225.46"
#define GOOGLE_TRANSLATE_HOSTNAME "translate.google.com"
...
void sendHTTPGet()
{
    string str = "GET /#" + src_lang + "/" + dst_lang + "/" + msg + "\r\n" +
        "Host: " + GOOGLE_TRANSLATE_HOSTNAME + "\r\n" +
...
#ifdef _DEBUG
    write("Attempting to connect to "+GOOGLE_TRANSLATE_HOSTNAME+ " on port "+ HTTP_PORT + "\n");
#endif	
    sc_result = socket_connect( sock, GOOGLE_TRANSLATE + " " + HTTP_PORT,
...
void resolveHost()
{
    resolve( GOOGLE_TRANSLATE_HOSTNAME, "hostResolved" );
}
...
string GetHelp() {
    return ("Syntax: translate <src> <dst> <message>\n\n" +
            "This command submits a query to Google Translate and\n" +
