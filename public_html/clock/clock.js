    ...
    $.fn.extend({ // Extend jQuery with custom plugin
        ...
        analogueClock: function(options) {
            ...
            return this.each(function() {
                ...
                $sec.css({top:0, left:( clockHalf-(parseInt($sec.width(), 10) / 2) )+'px', height:clockH+'px'});
                $min.css({top:0, left:( clockHalf-(parseInt($min.width(), 10) / 2) )+'px', height:clockH+'px'});
                $hour.css({top:0, left:( clockHalf-(parseInt($hour.width(), 10) / 2) )+'px', height:clockH+'px'});
